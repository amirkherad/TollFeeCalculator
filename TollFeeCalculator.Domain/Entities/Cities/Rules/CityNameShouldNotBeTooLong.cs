...
public class CityNameShouldNotBeTooLong 
    : IBusinessRule
{
    ...
    public CityNameShouldNotBeTooLong(string name)
    {
        _name = name;
    }
    ...
    /// </summary>
    public string Message => $"The {nameof(City.Name)} can't be more than {Constants.MaxNameLength} characters.";
}